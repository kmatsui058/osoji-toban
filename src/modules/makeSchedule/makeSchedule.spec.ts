...
describe('makeSchedule', ()=>{
    ...
    test('test makeSchedule', ()=>{
        ...
        expect(result[1].member.name).toBe('test3')
        expect(result[1].date.format('YYYY/MM/DD')).toBe('2021/09/08')
        expect(result[2].member.name).toBe('test2')
        ...
        expect(result[4].member.name).toBe('test2')
        expect(result[4].date.format('YYYY/MM/DD')).toBe('2021/09/14')
        expect(result[5].member.name).toBe('test3')
        ...
        expect(result[7].member.name).toBe('test2')
        expect(result[7].date.format('YYYY/MM/DD')).toBe('2021/09/21')
        expect(result[8].member.name).toBe('test3')
        ...
        expect(result[10].member.name).toBe('test2')
        expect(result[10].date.format('YYYY/MM/DD')).toBe('2021/09/28')
        expect(result[11].member.name).toBe('test3')
        ...
        expect(result[13].member.name).toBe('test2')
        ...
        expect(result[15].member.name).toBe('test3')
        expect(result[15].date.format('YYYY/MM/DD')).toBe('2021/10/06')
        expect(result[16].member.name).toBe('test2')
        expect(result[16].date.format('YYYY/MM/DD')).toBe('2021/10/07')
        expect(result[17].member.name).toBe('test3')
